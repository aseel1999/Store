...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $items = Category::with('products')->filter()->orderBy('id', 'desc')->paginate($this->settings->paginateTotal);
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image') && $request->image != '') {
            $item->image = $this->storeImage($request->image, 'categories');
        }
        $item->save();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->hasFile('image') && $request->image != '') {
            $item->image = $this->storeImage($request->image, 'categories' , $item->getRawOriginal('image') );
        }
