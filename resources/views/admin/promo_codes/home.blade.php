            ...
            <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                ...
                <div class="d-flex align-items-center flex-wrap mr-1">
                    <div class="d-flex align-items-baseline mr-5">
                        <h3>{{ucwords(__('cp.promo_codes'))}}</h3>
                    </div>
                </div>
                <!--end::Info-->
                <!--begin::Toolbar-->
                ...
                <div>
                    ...
                    <a href="{{url(getLocal().'/admin/promo_codes/create')}}" class="btn btn-secondary  mr-2 btn-success">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-25p"> {{ucwords(__('cp.end_date'))}}</th>
                                    <th class="wd-25p"> {{ucwords(__('cp.max_usage'))}}</th>
{{--                                    <th class="wd-25p"> {{ucwords(__('cp.provider'))}}</th>--}}
...
{{--                                        <td class="v-align-middle wd-5p"><img src="{{$one->image}}" width="50px" height="50px"></td>--}}
                                        ...
                                        <td class="v-align-middle wd-25p">{{$one->amount}}</td>
                                        <td class="v-align-middle wd-25p">{{$one->discount_type =='0' ? __('cp.percentage'): __('cp.fixed_amount')}}</td>
                                        <td class="v-align-middle wd-25p">{{$one->end_date}}</td>
                                        <td class="v-align-middle wd-25p">{{$one->max_usage}}</td>
{{--                                        <td class="v-align-middle wd-25p">{{@$one->user->name ? :__('cp.all')}}</td>--}}
                                        ...
                                        <td class="v-align-middle wd-15p optionAddHours">
                                            <a href="{{url(getLocal().'/admin/promo_codes/'.$one->id.'/edit')}}"
