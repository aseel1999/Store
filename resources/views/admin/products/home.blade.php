                        ...
                        <div class="table-responsive">
                            <table class="table table-hover tableWithSearch" id="tableWithSearch">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-10p"> {{ucwords(__('cp.category'))}}</th>
                                    <th class="wd-10p"> {{ucwords(__('cp.brand'))}}</th>
                                    <th class="wd-10p"> {{ucwords(__('cp.price'))}}</th>
                                    <th class="wd-10p"> {{ucwords(__('cp.discount'))}}</th>
                                ...
                                @forelse($items as $one)
                                    <tr class="odd gradeX" id="tr-{{$one->id}}">
                                        ...
                                        <td class="v-align-middle wd-10p">{{@$one->name}}</td>
                                        <td class="v-align-middle wd-10p">{{$one->category->name}}</td>
                                        <td class="v-align-middle wd-10p">{{@$one->brand->brand_name}}</td>
                                        <td class="v-align-middle wd-10p">{{@$one->price}}</td>
                                        <td class="v-align-middle wd-10p">{{@$one->discount}}</td>
