                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            @foreach($brands as $brand)
                                                    <option value="{{$brand->id}}" data-id="{{$brand->id}}" {{$product->brand_id==$brand->id ? 'selected':''}}> {{$brand->name}} </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-solid"
                                                       ...
                                                       {{($locale->lang == 'ar') ? 'dir=rtl' :'' }} value="{{old('name_'.$locale->lang,@$product->translate($locale->lang)->name)}}"
                                                       required/>
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control form-control-solid" name="price" value="{{old('price',$product->price)}}" required />
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{__('cp.discount')}}</label><span style="color: #7b7878; font-size: 13px;" >( @lang('cp.optional') )</span>
                                            <input type="number" class="form-control form-control-solid" name="discount" value="{{old('discount',$product->discount)}}"/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control kt-tinymce-4"                                                              {{($locale->lang == 'ar') ? 'dir=rtl' :'' }} name="description_{{$locale->lang}}"
                                                       rows="4" required>{!! @$product->translate($locale->lang)->description!!}</textarea>
                                        </div>
                                    </div>
                                    @endforeach
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="fileinput-new thumbnail"
                                                    ...
                                                    <img src="{{$product->image}}" id="editImage" alt="">
                                                </div>
                                                <div class="btn red"
                                                     onclick="document.getElementById('edit_image').click()">
