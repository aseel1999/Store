						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
                                ...
                                @if(can(['countries-show' , 'countries-create' , 'countries-edit' , 'countries-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "countries") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/countries')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Cooking/Fork-spoon-knife.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="menu-text">{{__('cp.countries')}}</span>
                                        </a>
                                    </li>
                                ...
                                @if(can(['colors-show' , 'colors-create' , 'colors-edit' , 'colors-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "colors") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/colors')}}" class="menu-link">
										<span class="svg-icon menu-icon">
								...
								@if(can(['sizes-show' , 'sizes-create' , 'sizes-edit' , 'sizes-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "sizes") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/sizes')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Border.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
								...
								@if(can(['promo_codes-show' , 'promo_codes-create' , 'promo_codes-edit' , 'promo_codes-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "promo_codes") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/promo_codes')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Border.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="menu-text">{{__('cp.promo_codes')}}</span>
                                        </a>
                                    </li>
								...
								@if(can(['brands-show' , 'brands-create' , 'brands-edit' , 'brands-delete']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "brands") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/brands')}}" class="menu-link">
										<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Border.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <rect x="0" y="0" width="24" height="24"/>
                                            ...
                                            <span class="menu-text">{{__('cp.brands')}}</span>
                                        </a>
                                    </li>
								...
								<li class="menu-item {{(explode("/", request()->url())[5] == "cities") ? "menu-item-here" : ''}}" aria-haspopup="true">
									<a href="{{url(getLocal().'/admin/cities')}}" class="menu-link">
									<span class="svg-icon menu-icon">
									<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Border.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
											<rect x="0" y="0" width="24" height="24"/>
										...
										<span class="menu-text">{{__('cp.cities')}}</span>
									</a>
								</li>
								...
								@if(can(['pages-show', 'pages-edit']))
                                    <li class="menu-item {{(explode("/", request()->url())[5] == "pages") ? "menu-item-here" : ''}}" aria-haspopup="true">
                                        <a href="{{url(getLocal().'/admin/pages')}}" class="menu-link">
											<span class="svg-icon menu-icon">
										<!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Files/File.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <polygon points="0 0 24 0 24 24 0 24"/>
